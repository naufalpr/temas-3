...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Ubah Agenda</h1>
  </div>
  <div class="col-lg-8">
    <form method="post" action="/dashboard/agenda/{{ $agenda->slug }}" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="slug" name="slug" required value="{{ old('slug', $agenda->slug) }}">
            @error('slug')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            @if($agenda->image)
                <img src="{{ asset('storage/' . $agenda->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block" alt="">
            @else
        ...
        <div class="mb-3">
            ...
            @enderror
            <input id="body" type="hidden" name="body" value="{{ old('body', $agenda->body) }}">
