  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item"><a href="../DaftarWisata/tempatwisata.html"><i class="text-primary">Tempat Wisata</i></a></li>
      </ul>
    </nav>
    ...
    <div class="container my-5">
      <div class="row mb-4 gx-3 gy-3">
        <div class="col-md-4">
          <div class="card">
            <img src="Assets/kamar_standar_1.jpg" class="card-img-top" alt="Jawa-Timur-Park-2" />
            <div class="card-body">
              <p class="card-title">Jawa Timur Park 2</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
            <img src="Assets/kamar_standar_1.jpg" class="card-img-top" alt="Batu Secret Zoo" />
            <div class="card-body">
              <p class="card-title">Batu Secret Zoo</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
